...
if __name__ == '__main__':
    ...
    argParser.add_option("-d", "--sampling_mode_for_discriminator", default="rebalance", type="string", dest="dratio_mode")
    argParser.add_option("-g", "--sampling_mode_for_generator", default="rebalance", type="string", dest="gratio_mode")
